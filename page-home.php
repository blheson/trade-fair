...
<div class="sg-home">
	...
	border-radius: 30px;">
								...
								<img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/partner.jpg'; ?>" alt="partner" loading='lazy'>
			...
			<div class="u-flex ">
				<div class="u-flex-child u-flex-child--w-33">
					<div class="team-image">
						<img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/team/team3.jpg'; ?>" alt="" width="100%">
					</div>
				...
				<div class="u-flex-child u-flex-child--w-33">
					<div class="team-image">
						<img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/team/team4.jpg'; ?>" alt="" width="100%">
					</div>
				...
				<div class="u-flex-child u-flex-child--w-33">
					<div class="team-image">
						<img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/team/team1.jpg'; ?>" alt="" width="100%">
					</div>
				...
				<div class="u-flex-child u-flex-child--w-33 ">
					<div class="team-image">
						<img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/team/team2.jpeg'; ?>" alt="" width="100%">
					</div>
		...
		<div class="l-container l-container--lg">
			...
			<div class="c-feature c-feature--reversed">
				...
				foreach ( $products as $product ) {
					...
					?>
					<a href="/form?productId=<?php echo $product->get_id(); ?>"><div class="m-1" style="    padding: 20px 10px;border: 1px solid #c2bcbc;text-align: center;border-radius: 30px;box-shadow: 2px 8px 16px 0 rgb(47 113 167 / 19%);">
						<div class="product-image">
							<?php echo $product->get_image( 'thumbnail' ); ?>
						</div>
						<h3><?php echo $product->get_name(); ?></h3>
						<p><?php echo $product->get_price_html(); ?></p>
						<!-- onclick="BabyFairTheme.triggerFormByProduct('product_buy_php echo $product->get_id();')" -->
						<button id="product_buy_<?php echo $product->get_id(); ?>" style="padding:10px"  data-product-price="<?php echo $product->get_price(); ?>" data-product-id="<?php echo $product->get_id(); ?>" data-product-name="<?php echo $product->get_name(); ?>">
							Purchase
						</button>
					</div></a>
